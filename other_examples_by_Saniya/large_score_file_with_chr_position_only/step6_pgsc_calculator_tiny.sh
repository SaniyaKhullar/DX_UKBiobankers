...
samplesheet_path="/${main_folder}/pgsc_calc_${pgs_catalog_id}_${genome_build}_samplesheet.csv"
...
output_folder="${main_folder}/pgsc_calc_output_by_pgs_id_ancestry" # Output folder
